...
4. (Opcjonalnie) dodaj `UPSTASH_REDIS_REST_URL` i `UPSTASH_REDIS_REST_TOKEN`, żeby limit opinii działał trwale na serverless; bez tego używany jest limit w pamięci procesu.
