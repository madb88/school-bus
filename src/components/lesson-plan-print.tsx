...
import { buildWeeklyLessonPrint } from "@/lib/dowozy/weekly-print";
...
export function LessonPlanPrint({ schedule, plan }: LessonPlanPrintProps) {
  ...
  const days = buildWeeklyLessonPrint(schedule, plan, windowMin);

  return (
    <section className="lesson-plan-print hidden print:block">
      ...
      {/* Extra right pad + outline keep the outer border visible on paper */}
